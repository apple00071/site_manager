...
export function ProposalBuilder({
    ...
    useEffect(() => {
        ...
        const handleTouchMove = (e: TouchEvent) => {
            ...
            if (scrollEl) {
                const touchDiff = touchY - (window as any)._builderTouchStartY || 0;
        ...
        const handleTouchStart = (e: TouchEvent) => {
            (window as any)._builderTouchStartY = e.touches[0].clientY;
            e.stopPropagation();
        };
    ...
    return createPortal(
        <div
            ...
            aria-modal="true"
        >
            <div className="absolute right-0 top-0 bottom-0 bg-white w-full max-w-lg flex flex-col shadow-2xl animate-slide-in-right" style={{ overscrollBehavior: 'none' }}>
                {/* Header */}
