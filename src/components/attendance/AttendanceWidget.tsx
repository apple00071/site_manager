        ...
        <div className="flex items-center gap-2">
            {status === 'out' ? (
                <button
                    ...
                    disabled={loading}
                    className={`flex items-center gap-2 bg-yellow-500 hover:bg-yellow-600 text-white rounded-xl font-bold shadow-sm transition-all active:scale-95 disabled:opacity-50 ${variant === 'compact' ? 'px-2 py-2' : 'px-5 py-2.5'}`}
                    title="Punch In"
                >
